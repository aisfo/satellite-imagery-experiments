...
conv1_w = tf.get_variable("conv1_w", [4, 4, 64, 112], initializer=tf.contrib.layers.xavier_initializer_conv2d())
conv1_b = tf.get_variable("conv1_b", [112], initializer=tf.random_normal_initializer(0))
...
conv2_w = tf.get_variable("conv2_w", [3, 3, 112, 80], initializer=tf.contrib.layers.xavier_initializer_conv2d())
